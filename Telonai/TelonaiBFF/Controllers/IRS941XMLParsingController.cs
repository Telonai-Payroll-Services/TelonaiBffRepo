...
namespace TelonaiWebApi.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class IRS941XMLParsingController : ControllerBase
    {
        private readonly IIRSService _irsService;
        public IRS941XMLParsingController(IIRSService irsService)
        {
            _irsService = irsService;
        }

        [HttpGet]
        public ActionResult<IRS941> GenerateXML()
        {
