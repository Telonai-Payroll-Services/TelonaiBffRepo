...
public class WorkScheduleController : ControllerBase
{
    ...
    public WorkScheduleController(IWorkScheduleService ScheduleService, IScopedAuthorization scopedAuthrorization)
    {
    ...
    {
       _scopedAuthrorization.ValidateByJobId(Request.HttpContext.User, AuthorizationType.User, model.JobId);
