...
public class PayrollsController : ControllerBase
{
    ...
    public PayrollsController(IPayrollService payrollService, IScopedAuthorization scopedAuthrorization)
    {
    ...
    public IActionResult GetById(int id)
    {
        ...
        _scopedAuthrorization.ValidateByCompanyId(Request.HttpContext.User, AuthorizationType.User, item.CompanyId);
        return Ok(item);
    }
